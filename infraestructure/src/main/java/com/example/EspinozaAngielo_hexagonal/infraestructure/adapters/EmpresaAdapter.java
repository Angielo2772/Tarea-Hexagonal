package com.example.EspinozaAngielo_hexagonal.infraestructure.adapters;

import com.example.EspinozaAngielo_hexagonal.domain.aggregates.constants.Constants;
import com.example.EspinozaAngielo_hexagonal.domain.aggregates.dto.EmpresaDto;
import com.example.EspinozaAngielo_hexagonal.domain.aggregates.response.ResponseSunat;
import com.example.EspinozaAngielo_hexagonal.domain.ports.out.EmpresaServiceOut;
import com.example.EspinozaAngielo_hexagonal.infraestructure.dao.EmpresaRepository;
import com.example.EspinozaAngielo_hexagonal.infraestructure.entity.EmpresaEntity;
import com.example.EspinozaAngielo_hexagonal.infraestructure.mapper.EmpresaMapper;
import com.example.EspinozaAngielo_hexagonal.infraestructure.rest.SunatClient;
    ...
    private EmpresaEntity getEntity(String ruc) {
        ...
        if (Objects.nonNull(responseSunat)) {
            return EmpresaEntity.builder()
                    ...
                    .estado1(responseSunat.getEstado())
